  ...
  */
  ...
  static computeLeaderboard(bot, leaderboard) {
    ...
    leaderboard.map(key => computedArray.push({
        ...
        username: bot.users.get(key.userID) ? bot.users.get(key.userID).username : "Unknown",
        discriminator: bot.users.get(key.userID) ? bot.users.get(key.userID).discriminator : "0000"
      }));
