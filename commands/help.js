...
module.exports.run = async (bot, message, args) => {
  ...
  .setDescription(`Invite BitVerify to other servers with this link:
  https://discord.com/oauth2/authorize?client_id=707376789860778046&permissions=8&scope=bot`)
